...
export const PropertyCard: React.FC<PropertyCardProps> = ({
  ...
  const { id, title, location, price, currency = '€', imageUrl, bedrooms, bathrooms, livingRooms, status } = property;
  ...
  return (
    ...
    >
      ...
      <div className="p-4">
        ...
        {/* Caractéristiques en badge */}
        <div className="mb-4 flex flex-wrap gap-2">
          <div className="flex items-center gap-1 rounded-full bg-gray-100 px-3 py-1 text-xs font-medium text-gray-700 dark:bg-gray-800 dark:text-gray-300">
